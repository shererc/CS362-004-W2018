...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
      ...
      for (i = 0; i < 3; i++)
	{
      ...
      return 0;
		*/
    return smithy_effect(handPos, currentPlayer, state);
    ...
    /*
      ...
      return 0;
    */
    return village_effect(handPos, currentPlayer, state);
    ...
    /*
      ...
      return 0;
		*/
    return great_hall_effect(handPos, currentPlayer, state);
...
int adventurer_effect(struct gameState *state, int currentPlayer){
    ...
    while (drawntreasure < 1){
      ...
      drawCard(currentPlayer, state);
      cardDrawn = state->hand[currentPlayer][state->handCount[currentPlayer] - 1]; //top card of hand is most recently drawn card.
      if (cardDrawn == copper || cardDrawn == silver || cardDrawn == gold || cardDrawn == embargo)
        drawntreasure++;
      else
      {
        temphand[z] = cardDrawn;
